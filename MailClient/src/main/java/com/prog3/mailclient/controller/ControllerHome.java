...
public class ControllerHome implements Initializable {
    ...
    protected void onButtonNewEmailClick() {
        ...
        try {
            ...
            stage.initModality(Modality.APPLICATION_MODAL); // La finestra diventa "figlia" della home page
            stage.initOwner(this.stage); // Quando è aperta la pagina della nuova email non è possibile effettuare altre operazioni sulla finestra della home finchè non viene chiusa
