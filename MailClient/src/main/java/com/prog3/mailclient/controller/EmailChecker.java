...
class EmailChecker implements Runnable {
    ...
    public void run() {
        try {
            ...
            // Trova ID dell'ultima email ricevuta
            ...
            // Invia una richiesta al server per verificare la presenza di nuove email
            ...
            if (response instanceof List) {
                // Se sono presenti nuove email le aggiunge alla lista di email ricevute
                ...
                // Aggiornamento della listview con le nuove email
